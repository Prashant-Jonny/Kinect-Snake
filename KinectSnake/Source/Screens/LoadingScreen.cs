    ...
    class LoadingScreen : Screen
    {
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (otherScreensAreGone)
            {
                ...
                for (int i = 0; i < screensToLoad.Length; i ++)// screen in screensToLoad)
                {
                    if (screensToLoad[i] != null)
                    {
                        ScreenManager.AddScreen(screensToLoad[i], ControllingPlayer,i);
                    }
                }
        ...
        public override void Draw()
        {
            ...
            if (loadingIsSlow)
            {
                ...
                Vector2 textSize = TextSettings.CurrentFont.MeasureString(message);
                Vector2 textPosition = (viewportSize - textSize) / 2;

                Color color = Color.White * TransitionAlpha;

                // Draw the text.
                ScreenManager.SpriteBatch.DrawString(TextSettings.CurrentFont, message, textPosition, color);
            }
        }
